    ...
    <div class="dashboard" id="dashboard-container">
      <header class="header">
        ...
        <nav class="nav">
          ...
          <router-link to="/keuangan" class="nav-link" :class="{ 'active': $route.path === '/keuangan' }">Keuangan</router-link>
        </nav>
...
export default {
  ...
  methods: {
    ...
    addTransaksi() {
      this.$router.push('/keuangan/transaksi/tambah');
    },
    editTransaksi(index) {
      this.$router.push(`/keuangan/transaksi/edit/${index}`);
    },
    addAnggaran() {
      this.$router.push('/keuangan/rencana-anggaran/tambah');
    },
    editAnggaran(index) {
      this.$router.push(`/keuangan/rencana-anggaran/edit/${index}`);
    },
