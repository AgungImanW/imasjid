    ...
    <div class="dashboard" id="dashboard-container">
      <header class="header">
        ...
        <nav class="nav">
          ...
          <router-link to="/kegiatan" class="nav-link" :class="{ 'active': $route.path === '/kegiatan' }">Kegiatan</router-link>
...
export default {
  ...
  methods: {
    ...
    editKegiatan(index) {
      this.$router.push(`/kegiatan/edit/${index}`);
    },
    ...
    goToEditJadwal(index) {
      // Navigate to edit page with the index as parameter
      this.$router.push({
        path: '/edit-jadwal',
        query: { 
          index: index,
