<template>
  <div class="container">
    <form @submit.prevent="handleSubmit" @reset="handleReset" class="form-card">
      <h2 class="form-title">Form Tambah Kegiatan</h2>
...
export default {
  ...
  setup() {
    ...
    const handleSubmit = async () => {
      ...
      let fotoBase64 = "@/assets/icon/kegiatan.png"
      ...
      const existingKegiatan = JSON.parse(localStorage.getItem('kegiatanList') || '[]')
      existingKegiatan.push(newKegiatan)
      localStorage.setItem('kegiatanList', JSON.stringify(existingKegiatan))
